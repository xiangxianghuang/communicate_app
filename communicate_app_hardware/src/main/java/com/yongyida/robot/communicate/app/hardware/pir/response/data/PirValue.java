package com.yongyida.robot.communicate.app.hardware.pir.response.data;
 ...
 * 人体监测数据
 */
public class PirValue extends BaseResponseControl {

    private boolean hasPeople ;         // 是否有人
    private int peopleDistance = -1 ;        // 人的距离
    ...
    public void setPeopleDistance(int peopleDistance) {
