package com.yongyida.robot.model.y165.pir.control;
 ...
 */
public class Y165QueryPirValueControlHandler extends QueryPirValueControlHandler{

    public Y165QueryPirValueControlHandler(Context context) {
        super(context);
    }
    ...
    protected void startListenPir(OnPirValueChangedListener onTouchPositionListener) {
        ...
        Y165Receive.getInstance().setOnPirValueChangedListener(onTouchPositionListener);
    }
