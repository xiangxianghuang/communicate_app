 ...
 */
public abstract class ArmTeacherModeControlHandler extends BaseControlHandler<ArmTeacherModeControl> {

    public ArmTeacherModeControlHandler(Context context) {
        super(context);
    }
