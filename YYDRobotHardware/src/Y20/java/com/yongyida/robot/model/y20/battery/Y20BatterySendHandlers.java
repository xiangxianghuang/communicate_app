 ...
 */
public class Y20BatterySendHandlers extends BatterySendHandlers {

    private final static String TAG = Y20BatterySendHandlers.class.getSimpleName() ;


    private BatteryInfo batteryInfo = new BatteryInfo() ;


    public Y20BatterySendHandlers(Context context) {
        super(context);
