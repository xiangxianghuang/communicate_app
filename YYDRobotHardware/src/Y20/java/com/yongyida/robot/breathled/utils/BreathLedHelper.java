...
//        BreathLed.setOnoff(position,FUNCTION_ON) ;
    ...
    public static String getPosition(int position){
        ...
        if(position == LedStatue.POSITION_ALL){//全部

            positionString = BreathLedHelper.POSITION_ALL ;

        }else if((position & LedStatue.POSITION_CHEST)== LedStatue.POSITION_CHEST){   // 胸部

            if(((position & LedStatue.POSITION_LEFT_EAR) == LedStatue.POSITION_LEFT_EAR) || //左耳
                    ((position & LedStatue.POSITION_RIGHT_EAR) == LedStatue.POSITION_RIGHT_EAR)){//右耳
        ...
        }else if(((position & LedStatue.POSITION_LEFT_EAR) == LedStatue.POSITION_LEFT_EAR) || //左耳
                ((position & LedStatue.POSITION_RIGHT_EAR) == LedStatue.POSITION_RIGHT_EAR)){//右耳
    ...
    public static String getPower(LedStatue.Power power){
        ...
        return power == LedStatue.Power.POWER_ON ? FUNCTION_ON : FUNCTION_OFF;

    }

    public static String getColor(LedStatue.Color color){
    ...
    public static String getEffect(LedStatue.Effect effect){
