...
import com.yongyida.robot.communicate.app.hardware.motion.control.ArmControlHandler;
 ...
 */
public class Y148ArmControlHandler extends ArmControlHandler {

    private Arm mArm;

    public Y148ArmControlHandler(Context context) {
    ...
    public SendResponse onHandler(ArmControl armControl, IResponseListener responseListener) {
        ...
        return mArm.onHandler(armControl, responseListener);
    }
