...
import com.yongyida.robot.communicate.app.hardware.led.control.LedSend2ControlHandler;
 ...
 */
public class Y148LedSend2ControlHandler extends LedSend2ControlHandler {

    private SerialLed mSerialLed ;
    ...
    @Override
    public SendResponse onHandler(LedSend2Control baseSendControl, IResponseListener responseListener) {

        mSerialLed.controlLed(baseSendControl);
