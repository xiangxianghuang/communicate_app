 ...
 */
public class Y148BatterySendHandlers extends BatterySendHandlers {

    public Y148BatterySendHandlers(Context context) {
        super(context);

        addBaseControlHandler(new Y148QueryBatteryControlHandler(context));
    }
